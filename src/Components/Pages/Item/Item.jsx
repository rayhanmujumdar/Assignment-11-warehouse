    ...
    return (
        ...
        <div className="rounded-lg shadow-lg bg-[#2C5364] max-w-sm flex flex-col justify-end">
          ...
          <div className="p-6 text-left">
            ...
            <button onClick={() => navigate(`/inventory/${_id}`)} type="button" className="w-full inline-block px-6 py-2.5 bg-gray-700 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-500 hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out">Stock Update</button>
          </div>
        </div>
      </div>
    );
